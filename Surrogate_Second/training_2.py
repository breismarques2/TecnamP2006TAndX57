...
def main():   
    ...
    regr_cdi_total = MLPRegressor(activation= 'relu', solver='adam', learning_rate='adaptive', learning_rate_init=0.0001, tol=1e-55, 
                                  ...
                                  n_iter_no_change= 700, hidden_layer_sizes=(1000,1000,1000))
    ...
    #filename = 'NN_Surrogate_Model_MLPRegressor_CDi_HS_2.sav'
    ...
    #filename = 'NN_Surrogate_Model_MLPRegressor_CDi_Wing_2.sav'
    #pickle.dump(regr_cdi_wing, open(filename, 'wb'))
    
    #filename = 'NN_Surrogate_Model_MLPRegressor_CL_HS_2.sav'
    #pickle.dump(regr_cl_hs, open(filename, 'wb'))
    
    #filename = 'NN_Surrogate_Model_MLPRegressor_CL_VS_2.sav'
    #pickle.dump(regr_cl_vs, open(filename, 'wb'))
    
    #filename = 'NN_Surrogate_Model_MLPRegressor_CL_Wing_2.sav'
    #pickle.dump(regr_cl_wing, open(filename, 'wb'))
    
    filename = 'NN_Surrogate_Model_MLPRegressor_CDi_2.sav'
    ...
    #filename = 'NN_Surrogate_Model_MLPRegressor_CL_2.sav'

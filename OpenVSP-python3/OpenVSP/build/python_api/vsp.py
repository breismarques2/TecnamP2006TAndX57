...
GetVSPExePath = _vsp.GetVSPExePath

def RegisterCFDMeshAnalyses():
    return _vsp.RegisterCFDMeshAnalyses()
RegisterCFDMeshAnalyses = _vsp.RegisterCFDMeshAnalyses
...
GetResultsName = _vsp.GetResultsName
...
GetDoubleMatResults = _vsp.GetDoubleMatResults
...
GetGeomTypeName = _vsp.GetGeomTypeName
...
GetGeomParent = _vsp.GetGeomParent

def GetGeomChildren(geom_id):
    return _vsp.GetGeomChildren(geom_id)
GetGeomChildren = _vsp.GetGeomChildren
...
GetGeomBBoxMax = _vsp.GetGeomBBoxMax
...
GetGeomBBoxMin = _vsp.GetGeomBBoxMin
...
GetFeaStructIDVec = _vsp.GetFeaStructIDVec

def SetFeaPartName(part_id, name):
    return _vsp.SetFeaPartName(part_id, name)
SetFeaPartName = _vsp.SetFeaPartName
...
SetFeaPartPerpendicularSparID = _vsp.SetFeaPartPerpendicularSparID

def GetFeaPartPerpendicularSparID(part_id):
    return _vsp.GetFeaPartPerpendicularSparID(part_id)
GetFeaPartPerpendicularSparID = _vsp.GetFeaPartPerpendicularSparID
...
SetXSecWidth = _vsp.SetXSecWidth

def SetXSecHeight(xsec_id, h):
    return _vsp.SetXSecHeight(xsec_id, h)
SetXSecHeight = _vsp.SetXSecHeight
...
ChangeBORXSecShape = _vsp.ChangeBORXSecShape

def GetBORXSecShape(geom_id):
    return _vsp.GetBORXSecShape(geom_id)
GetBORXSecShape = _vsp.GetBORXSecShape
...
GetHersheyBarDragDist = _vsp.GetHersheyBarDragDist
...
GetFeatureLinePnts = _vsp.GetFeatureLinePnts
...
TransformSet = _vsp.TransformSet
...
UpdateParasiteDrag = _vsp.UpdateParasiteDrag

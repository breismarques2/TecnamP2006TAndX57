#ifndef  TYPE_SDAIWORK_ITEM_H
#define  TYPE_SDAIWORK_ITEM_H
...
class SC_SCHEMA_EXPORT SdaiWork_item  :  public SDAI_Select {
  protected:
    //  types in SELECT 
...
// constructors
    SdaiWork_item( const SelectTypeDescriptor * =config_control_design::t_work_item );
    //  part 1
    SdaiWork_item( const SdaiProduct_definition_formation_ptr&,
                   const SelectTypeDescriptor * =config_control_design::t_work_item );
...
inline SDAI_Select * create_SdaiWork_item () { return new SdaiWork_item; }
typedef SdaiWork_item * SdaiWork_itemH;
typedef SdaiWork_item_ptr SdaiWork_item_var;


class SdaiWork_item_agg : public SelectAggregate {
  protected:
    SelectTypeDescriptor *sel_type;

  public:
    SdaiWork_item_agg( SelectTypeDescriptor * =config_control_design::t_work_item );
    ~SdaiWork_item_agg();
    virtual SingleLinkNode * NewNode()
     { return new SelectNode (new SdaiWork_item( sel_type )); }
};
inline STEPaggregate * create_SdaiWork_item_agg () { return new SdaiWork_item_agg; }
typedef SdaiWork_item_agg_ptr SdaiWork_item_agg_var;

...
// constructors
    SdaiSurface_model( const SelectTypeDescriptor * =config_control_design::t_surface_model );
    //  part 1
    SdaiSurface_model( const SdaiShell_based_surface_model_ptr&,
                       const SelectTypeDescriptor * =config_control_design::t_surface_model );
...
class SdaiSurface_model_agg : public SelectAggregate {
  ...
  public:
    SdaiSurface_model_agg( SelectTypeDescriptor * =config_control_design::t_surface_model );

...
SdaiDate_time_item::AssignEntity (SDAI_Application_instance * se)
{
  ...
  if (se -> IsA (config_control_design::e_approval_person_organization))
  {  
    _app_inst = (SdaiApproval_person_organization_ptr) se;
    return SetUnderlyingType (config_control_design::e_approval_person_organization);
  }
  //  CONTRACT
...
SdaiDate_time_item::STEPwrite_content (ostream& out, const char * currSch) const {
  (void)currSch;
    ...
    if (CurrentUnderlyingType () == config_control_design::e_approval_person_organization) {
        _app_inst -> STEPwrite_reference (out);
        return;
    }
...
SdaiDate_time_item::STEPwrite_verbose (ostream& out, const char *currSch) const
{
    ...
    if (td == config_control_design::e_approval_person_organization) {
        out <<  tmp << "(";
        _app_inst -> STEPwrite_reference (out);
        out << ")";
        return;
...
SdaiDate_time_item::SdaiDate_time_item( const SdaiApproval_person_organization_ptr& o,
                                        const SelectTypeDescriptor *typedescript )
  : SDAI_Select (typedescript, config_control_design::e_approval_person_organization)
{
#ifdef SC_LOGGING
    if( *logStream ) { *logStream << "DAVE ERR entering SdaiDate_time_item constructor." << std::endl; }
#endif
...
SdaiContract_type_ptr SdaiDate_time_item::kind_() {
  if( CurrentUnderlyingType () == config_control_design::e_contract ) 
    //  CONTRACT
...
SdaiContract_type_ptr_c SdaiDate_time_item::kind_() const {
  if( CurrentUnderlyingType () == config_control_design::e_contract ) 
    //  CONTRACT
...
void SdaiDate_time_item::kind_( const SdaiContract_type_ptr x ) {
  if( CurrentUnderlyingType () == config_control_design::e_contract ) 
    //  CONTRACT
...
SdaiChange_request_item_agg_ptr SdaiDate_time_item::items_() {
  if( CurrentUnderlyingType () == config_control_design::e_change_request ) 
    //  CHANGE_REQUEST
...
SdaiChange_request_item_agg_ptr_c SdaiDate_time_item::items_() const {
  if( CurrentUnderlyingType () == config_control_design::e_change_request ) 
    //  CHANGE_REQUEST
...
void SdaiDate_time_item::items_( const SdaiChange_request_item_agg_ptr x ) {
  if( CurrentUnderlyingType () == config_control_design::e_change_request ) 
    //  CHANGE_REQUEST
...
SdaiDate_time_item& SdaiDate_time_item::operator =( const SdaiApproval_person_organization_ptr& o )
{
   nullify ();
   _app_inst = o;
   SetUnderlyingType( config_control_design::e_approval_person_organization );
   return *this;
}
...
SdaiDate_time_item& SdaiDate_time_item::operator =( const SdaiDate_time_item_ptr& o ) {
    ...
    if ( o -> CurrentUnderlyingType() == config_control_design::e_approval_person_organization ) {
        _app_inst =  o -> _app_inst;
        return *this;
    }
...
void init_SdaiDate_time_item( Registry& reg ) {
    std::string str;
        config_control_design::t_date_time_item = new SelectTypeDescriptor (
        ...
        config_control_design::schema->AddType(config_control_design::t_date_time_item);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_product_definition);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_change_request);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_start_request);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_change);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_start_work);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_approval_person_organization);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_contract);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_security_classification);
    config_control_design::t_date_time_item -> Elements ().AddNode (config_control_design::e_certification);
    reg.AddType (*config_control_design::t_date_time_item);
}

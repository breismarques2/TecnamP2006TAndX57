...
SdaiSurface_model::AssignEntity (SDAI_Application_instance * se)
{
  ...
  if (se -> IsA (config_control_design::e_shell_based_surface_model))
  {  
    _app_inst = (SdaiShell_based_surface_model_ptr) se;
    return SetUnderlyingType (config_control_design::e_shell_based_surface_model);
  }
...
SdaiSurface_model::STEPwrite_content (ostream& out, const char * currSch) const {
  (void)currSch;
      if (CurrentUnderlyingType () == config_control_design::e_shell_based_surface_model) {
...
SdaiSurface_model::STEPwrite_verbose (ostream& out, const char *currSch) const
{
    ...
    if (td == config_control_design::e_shell_based_surface_model) {
        out <<  tmp << "(";
        _app_inst -> STEPwrite_reference (out);
        out << ")";
        return;
...
SdaiSurface_model::SdaiSurface_model( const SdaiShell_based_surface_model_ptr& o,
  ...
  : SDAI_Select (typedescript, config_control_design::e_shell_based_surface_model)
{
#ifdef SC_LOGGING
...
SdaiSurface_model& SdaiSurface_model::operator =( const SdaiShell_based_surface_model_ptr& o )
{
   nullify ();
   _app_inst = o;
   SetUnderlyingType( config_control_design::e_shell_based_surface_model );
   return *this;
}
...
SdaiSurface_model& SdaiSurface_model::operator =( const SdaiSurface_model_ptr& o ) {
    ...
    if ( o -> CurrentUnderlyingType() == config_control_design::e_shell_based_surface_model ) {
...
void init_SdaiSurface_model( Registry& reg ) {
    std::string str;
        config_control_design::t_surface_model = new SelectTypeDescriptor (
                  ~(0),        //unique elements,
                  "Surface_Model",        // Name
        ...
        config_control_design::schema->AddType(config_control_design::t_surface_model);
    config_control_design::t_surface_model -> Elements ().AddNode (config_control_design::e_shell_based_surface_model);
    reg.AddType (*config_control_design::t_surface_model);
}

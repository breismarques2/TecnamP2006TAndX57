#ifndef  TYPE_SDAIWORK_ITEM_CC
#define  TYPE_SDAIWORK_ITEM_CC
...
SdaiWork_item::AssignEntity (SDAI_Application_instance * se)
{
  (void)se;
...
Severity
SdaiWork_item::STEPread_content (istream& in, InstMgrBase * instances,
...
Severity
SdaiWork_item::StrToVal_content (const char * str, InstMgrBase * instances)
{
  (void)str;
  (void)instances;
  switch (base_type)  {
...
{
#ifdef SC_LOGGING
    if( *logStream ) { *logStream << "DAVE ERR entering SdaiWork_item constructor." << std::endl; }
#endif
   _app_inst = o;
#ifdef SC_LOGGING
    if( *logStream ) { *logStream << "DAVE ERR exiting SdaiWork_item constructor." << std::endl; }
#endif
}
...
SdaiWork_item_agg::SdaiWork_item_agg( SelectTypeDescriptor *s)
  : SelectAggregate(), sel_type(s)
{
}

SdaiWork_item_agg::~SdaiWork_item_agg() { }
...
SdaiProduct_ptr SdaiWork_item::of_product_() {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
SdaiProduct_ptr_c SdaiWork_item::of_product_() const {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
void SdaiWork_item::of_product_( const SdaiProduct_ptr x ) {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
SdaiText SdaiWork_item::description_() {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
const SdaiText SdaiWork_item::description_() const {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
void SdaiWork_item::description_( const SdaiText x ) {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
SdaiIdentifier SdaiWork_item::id_() {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
const SdaiIdentifier SdaiWork_item::id_() const {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
void SdaiWork_item::id_( const SdaiIdentifier x ) {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
SDAI_Select& SdaiWork_item::operator =( const SDAI_Select& o ) {
    SDAI_Select::operator=( o );
    if ( o.CurrentUnderlyingType() == config_control_design::e_product_definition_formation ) {
...
void init_SdaiWork_item( Registry& reg ) {
    std::string str;
        config_control_design::t_work_item = new SelectTypeDescriptor (
                  ~(0),        //unique elements,
                  "Work_Item",        // Name
        ...
        config_control_design::schema->AddType(config_control_design::t_work_item);
    config_control_design::t_work_item -> Elements ().AddNode (config_control_design::e_product_definition_formation);
    reg.AddType (*config_control_design::t_work_item);
}

...
// constructors
    SdaiCharacterized_product_definition( const SelectTypeDescriptor * =config_control_design::t_characterized_product_definition );
    //  part 1
    SdaiCharacterized_product_definition( const SdaiProduct_definition_ptr&,
                                          const SelectTypeDescriptor * =config_control_design::t_characterized_product_definition );
...
class SdaiCharacterized_product_definition_agg : public SelectAggregate {
  ...
  public:
    SdaiCharacterized_product_definition_agg( SelectTypeDescriptor * =config_control_design::t_characterized_product_definition );

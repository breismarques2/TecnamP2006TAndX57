#ifndef  TYPE_SDAICHANGE_REQUEST_ITEM_CC
#define  TYPE_SDAICHANGE_REQUEST_ITEM_CC
...
SdaiChange_request_item::AssignEntity (SDAI_Application_instance * se)
{
  (void)se;
...
Severity
SdaiChange_request_item::STEPread_content (istream& in, InstMgrBase * instances,
...
Severity
SdaiChange_request_item::StrToVal_content (const char * str, InstMgrBase * instances)
{
  (void)str;
  (void)instances;
  switch (base_type)  {
...
{
#ifdef SC_LOGGING
    if( *logStream ) { *logStream << "DAVE ERR entering SdaiChange_request_item constructor." << std::endl; }
#endif
   _app_inst = o;
#ifdef SC_LOGGING
    if( *logStream ) { *logStream << "DAVE ERR exiting SdaiChange_request_item constructor." << std::endl; }
#endif
}
...
SdaiChange_request_item_agg::SdaiChange_request_item_agg( SelectTypeDescriptor *s)
  : SelectAggregate(), sel_type(s)
{
}

SdaiChange_request_item_agg::~SdaiChange_request_item_agg() { }
...
SdaiProduct_ptr SdaiChange_request_item::of_product_() {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
SdaiProduct_ptr_c SdaiChange_request_item::of_product_() const {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
void SdaiChange_request_item::of_product_( const SdaiProduct_ptr x ) {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
SdaiText SdaiChange_request_item::description_() {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
const SdaiText SdaiChange_request_item::description_() const {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
void SdaiChange_request_item::description_( const SdaiText x ) {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
SdaiIdentifier SdaiChange_request_item::id_() {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
const SdaiIdentifier SdaiChange_request_item::id_() const {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
void SdaiChange_request_item::id_( const SdaiIdentifier x ) {
  if( CurrentUnderlyingType () == config_control_design::e_product_definition_formation ) 
    //  PRODUCT_DEFINITION_FORMATION
...
SDAI_Select& SdaiChange_request_item::operator =( const SDAI_Select& o ) {
    SDAI_Select::operator=( o );
    if ( o.CurrentUnderlyingType() == config_control_design::e_product_definition_formation ) {
...
void init_SdaiChange_request_item( Registry& reg ) {
    std::string str;
        config_control_design::t_change_request_item = new SelectTypeDescriptor (
                  ~(0),        //unique elements,
        ...
        config_control_design::schema->AddType(config_control_design::t_change_request_item);
    config_control_design::t_change_request_item -> Elements ().AddNode (config_control_design::e_product_definition_formation);
    reg.AddType (*config_control_design::t_change_request_item);
}

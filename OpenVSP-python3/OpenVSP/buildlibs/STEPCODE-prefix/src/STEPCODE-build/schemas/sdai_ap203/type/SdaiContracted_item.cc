...
void init_SdaiContracted_item( Registry& reg ) {
    std::string str;
        config_control_design::t_contracted_item = new SelectTypeDescriptor (
                  ~(0),        //unique elements,
        ...
        config_control_design::schema->AddType(config_control_design::t_contracted_item);
    config_control_design::t_contracted_item -> Elements ().AddNode (config_control_design::e_product_definition_formation);
    reg.AddType (*config_control_design::t_contracted_item);
}

...
def vehicle_setup():
    ...
    internalprop.rated_speed       = 2400.0 * Units['rpm']
    ...
    engine.speed              = 1800.0 * Units['rpm']  #5800
    engine.power_specific_fuel_consumption     =  0.83454*2. #0.83454 #4.19
...
def mission_setup(analyses):
    ...
    segment.mach_start     = 0.114   #0.05
    segment.mach_end       = 0.18        #0.111    #0.1
    ...
    segment.mach  = 0.174                               #0.105  #0.077       #0.099
    segment.distance   = 400.0 * Units.nautical_miles
...
def plot_mission(results,line_style='bo-'):
    ...
    # Distance
    # Plot Flight Conditions 
    plot_flight_conditions_distance(results, line_style)
    
    # Plot Aerodynamic Forces
    plot_aerodynamic_forces_distance(results, line_style)
    
    # Plot Aerodynamic Coefficients 
    plot_aerodynamic_coefficients_distance(results, line_style)
    
    # Drag Components
    plot_drag_components_distance(results, line_style)
    
    # Plot Altitude, sfc, vehicle weight 
    plot_altitude_sfc_weight_distance(results, line_style)
    
    # Plot Velocities 
    plot_aircraft_velocities_distance(results, line_style)
    
    # Plot propeller conditions
    plot_propeller_conditions_distance(results, line_style)

...
def vehicle_setup():
    ...
    internalprop.rated_speed       = 5800.0 * Units['rpm']
    ...
    engine.power_specific_fuel_consumption     = 0.83454*2.0 #0.83454 #4.19
...
def mission_setup(analyses):
    ...
    segment.mach_start     = 0.063
    segment.mach_end       = 0.1
    ...
    segment.mach  =  0.092
    segment.distance   = 2000.0 * Units.nautical_miles
    ...
    segment.mach_start     = 0.091
    segment.mach_end       = 0.05

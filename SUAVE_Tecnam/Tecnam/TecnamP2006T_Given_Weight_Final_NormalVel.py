...
def vehicle_setup():
    ...
    internalprop.rated_speed       = 4000.0 * Units['rpm']
    ...
    engine.power_specific_fuel_consumption     =  0.83454*4.7 #0.83454 #4.19
...
def mission_setup(analyses):
    ...
    segment.mach_end       = 0.197       #0.111    #0.1
    ...
    segment.mach  = 0.196
    #segment.altitude   = 2438.4   * Units.meter                              #0.105  #0.077       #0.099
    segment.distance   = 400.0 * Units.nautical_miles

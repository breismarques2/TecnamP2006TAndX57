...
def vehicle_setup():
    ...
    vehicle.mass_properties.max_zero_fuel             = 1230 * Units.kilogram
    ...
    # basic parameters
    vehicle.reference_area         = 14.80 * Units['meters**2']  
    ...
    #fuel.internal_volume = 0.0 * Units['meters**3'] #IMPORTANT
    ...
    batteryprop.engine_length     = 1.2 * Units.meter #1.2 #1.74
    ...
    batteryprop.nacelle_diameter  = 0.1732 * Units.meter     #0.1732        #0.58
    #batteryprop.voltage           = 72000.0 * Units.watts #72000.0
    ...
    bat.specific_energy      = 350. * Units.Wh/Units.kg  #265.0  #192.84
    bat.specific_power       = 0.34 * Units.kW/Units.kg  #0.837
    bat.resistance           = 0.006 #0.0153
    bat.max_voltage          = 500.  #72000.0
    ...
    etam                               = 0.95
    v                                  = batteryprop.battery.max_voltage *3/4
    omeg                               = prop_attributes.angular_velocity  
    io                                 = 4.0 
    start_kv                           = 1
    end_kv                             = 25
    ...
    motor.origin                       = batteryprop.propeller.origin  
    motor.propeller_radius             = batteryprop.propeller.tip_radius   

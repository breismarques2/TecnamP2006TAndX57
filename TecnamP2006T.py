...
def base_analysis(vehicle):
    ...
    aerodynamics = SUAVE.Analyses.Aerodynamics.Open_VSP_Analysis_Tecnam()
...
def vehicle_setup():
    ...
    internalprop.rated_power       = 74569.9872 * Units.watts #For Weight Analysis
    ...
    prop_attributes.design_altitude     = 1600.0 * Units.meter
    prop_attributes.design_thrust       = None
    prop_attributes.design_power        = 74569.99 * Units.watts  #59600
    ...
    engine.sea_level_power    = 74569.9872 * Units.watts
    engine.flat_rate_altitude = 0. * Units.meter
    engine.speed              = 5800.0 * Units['rpm']
    engine.power_specific_fuel_consumption     = 4.19
